...
//
//    /**
//     * [ensureCompositionCreated]翻译 确保你的组合已经被创建
//     *
//     *
//     *
//     */
...
//        /**
//         * [composition]初始状态为null
//         */
//        if (composition == null) {
//            try {
//                /**
//                 * [creatingComposition]是一个标记，finally会改回false
//                 *
//                 */
//                creatingComposition = true
//                /**
//                 * [setContent]这里是ViewGroup的setContent
//                 * 参数类型不一样
//                 * 更关键的是ComposeView内的setContent是AbstractComposeView的子类里创建的setContent,需要强转成ComposeView才能调用
//                 *
//                 * [?:]操作符（运算符） 如果左边是非空就直接返回，如果左边是空就往右边运算，又变为空就再往右边运算 [Elvis operator]运算符
//                 */
...
//        /**
//         * [content] Activity setContent内的代码
//         */
//        this.content.value = content
//        /**
//         * [isAttachedToWindow]当View已经挂接到Window，完全显示出来的时候，[onAttachedToWindow]函数就会得到回调
//         *
//         * 最常见的写法，第一次进入这里的时候isAttachedToWindow无法为true
//         * 一般调用不了[createComposition]
//         * 但是[onAttachedToWindow]得到回调后还会调用[createComposition]的父类
//         */
//        if (isAttachedToWindow) {
//            createComposition()
//        }
